...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String RESULT_JSON = "results";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null)
        {
            ...
            if(savedInstanceState.containsKey(RESULT_JSON))
                mSearchResultsTextView.setText((savedInstanceState.getString(RESULT_JSON)));
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(RESULT_JSON, result);
    }
}