...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder>{
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        boolean shouldAttachParentImediately = false;

        View view = inflater.inflate(LayoutIdForListItem, parent, shouldAttachParentImediately);
        NumberViewHolder nmbViewHolder = new NumberViewHolder(view);

        return nmbViewHolder;
    }
