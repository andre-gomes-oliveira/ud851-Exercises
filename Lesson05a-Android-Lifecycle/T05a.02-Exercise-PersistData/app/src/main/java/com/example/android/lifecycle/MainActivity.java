...
public class MainActivity extends AppCompatActivity {
    ...
    // COMPELTED (1) Create a key String called LIFECYCLE_CALLBACKS_TEXT_KEY
    ...
    // COMPELTED (2) Override onSaveInstanceState
    // Do steps 3 - 5 within onSaveInstanceState
    // COMPELTED (3) Call super.onSaveInstanceState
    // COMPELTED (4) Call logAndAppend with the ON_SAVE_INSTANCE_STATE String
    // COMPELTED (5) Put the text from the TextView in the outState bundle
