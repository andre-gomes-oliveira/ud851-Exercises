...
public class TaskContentProvider extends ContentProvider {
    ...
    public static final int PATH_TASKS = 100;
    public static final int PATH_TASKS_ID = 101;
    ...
    public static UriMatcher buildUriMatcher(){
        ...
        matcher.addURI(TaskContract.AUTHORITY, TaskContract.PATH_TASKS + "/#", PATH_TASKS_ID);
        return matcher;
    }
