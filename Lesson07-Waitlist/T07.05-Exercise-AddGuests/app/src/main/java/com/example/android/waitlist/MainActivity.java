...
public class MainActivity extends AppCompatActivity {
    ...
    // COMPELTED (1) Create local EditText members for mNewGuestNameEditText and mNewPartySizeEditText
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMPELTED (2) Set the Edit texts to the corresponding views using findViewById
    ...
    public void addToWaitlist(View view) {
        ...
        if (mNewGuestNameEditText.getText().equals("") ||
                mNewPartySizeEditText.getText().equals(""))
            return;
