...
public class ReminderUtilities {
    ...
    private static final String REMINDER_JOB_TAG;
    private static boolean sInitialized;

    static {
        REMINDER_INTERVAL_SECONDS = (60 * 15);
        SYNC_FLEXTIME_SECONDS = (60 * 15);
        REMINDER_JOB_TAG = "hydration_reminder_tag";
        sInitialized = false;
    }
    ...
    synchronized public static void scheduleChargingReminder(Context context){
        ...
        Job chargingJob = dispatcher.newJobBuilder()
        ...
        dispatcher.schedule(chargingJob);
        sInitialized = true;
    }
}
