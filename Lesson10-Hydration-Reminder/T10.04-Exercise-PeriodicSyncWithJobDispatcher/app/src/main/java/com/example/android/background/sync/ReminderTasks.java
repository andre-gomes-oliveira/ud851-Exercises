...
public class ReminderTasks {
    ...
    public static final String ACTION_CHARGING_REMINDER_NOTIFICATION;

    static {
        ACTION_INCREMENT_WATER_COUNT = "increment-water-count";
        ACTION_DISMISS_NOTIFICATION = "dismiss-notification";
        ACTION_CHARGING_REMINDER_NOTIFICATION = "reminder-notification";
    }
